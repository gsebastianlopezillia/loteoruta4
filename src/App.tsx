...
const testimonials = [
  ...
  {
    text: 'Puedo calificar de excelente mí experiencia como comprador de un lote! Agradecido por la atención y predisposición de los propietarios. Terrenos amplios, con una buena ubicación, con múltiples posibilidades!',
    subtitle: 'Particular - Los Helechos'
  }
];
          ...
          <div className="bg-gradient-to-r from-[#004D40] via-[#27AE60] to-[#004D40] overflow-hidden relative shadow-lg" style={{ height: '58px', display: 'flex', alignItems: 'center' }}>
            <div className="animate-scroll whitespace-nowrap">
              <span className="inline-block px-8 text-white" style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: 700, fontSize: '16px', letterSpacing: '0.5px' }}>
                🌞 OFERTA VERANO: con el lote te entregamos un tanque tricapa de 600lts 🌞
              </span>
              <span className="inline-block px-8 text-white" style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: 700, fontSize: '16px', letterSpacing: '0.5px' }}>
                🌞 OFERTA VERANO: con el lote te entregamos un tanque tricapa de 600lts 🌞
              </span>
              <span className="inline-block px-8 text-white" style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: 700, fontSize: '16px', letterSpacing: '0.5px', fontSize: '16px', letterSpacing: '0.5px' }}>
                🌞 OFERTA VERANO: con el lote te entregamos un tanque tricapa de 600lts 🌞
              </span>
            </div>
          </div>
        ...
        <footer className="bg-[#000000] py-20 border-t border-[#2a2a2a]" id="contacto">
          <div className="container mx-auto max-w-6xl px-4">
            <div className="grid md:grid-cols-3 gap-10 mb-10">
              ...
              <div className="animate-on-scroll">
                <h4 className="text-[#FFFFFF] mb-4 text-[22px]" style={{ fontFamily: "Montserrat, sans-serif", fontWeight: 600, letterSpacing: '0.3px' }}>Oferta Verano</h4>
                <div className="bg-[#27AE60]/10 border border-[#27AE60] rounded-lg p-4">
                  <p className="text-[18px] text-[#FFFFFF] mb-2" style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: 600 }}>
                    ☀️Con el lote te entregamos un tanque tricapa de 600lts
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="border-t border-[#2a2a2a] pt-8 text-center">
              <p className="text-[16px] text-[#999999]" style={{ fontFamily: 'Open Sans, sans-serif' }}>
                © 2026 Loteo Ruta 4 - loteoruta4.com - Todos los derechos reservados
              </p>
